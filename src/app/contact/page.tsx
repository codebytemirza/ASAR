...
export default function ContactPage() {
  ...
  return (
    <>
      <section className="py-20 md:py-32 min-h-screen bg-slate-50 border-b border-border">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-12">
              ...
              <div className="bg-white p-8 md:p-10 border border-border shadow-sm rounded-2xl">
                <h2 className="text-2xl font-extrabold text-[#082652] mb-6">What Happens Next?</h2>
                <div className="space-y-8 relative before:absolute before:inset-0 before:ml-[1.1rem] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border before:to-transparent">
                  ...
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    <div className="flex items-center justify-center w-9 h-9 rounded-full bg-[#082652] text-white font-bold text-sm shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 shadow-sm border-4 border-white">
                      1
                    </div>
                    <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-border bg-slate-50">
                      <h3 className="font-bold text-[#082652] mb-1">Discovery Call</h3>
                  ...
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    ...
                    <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-border bg-slate-50">
                      <h3 className="font-bold text-[#082652] mb-1">Architectural Blueprint</h3>
                  ...
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    ...
                    <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-border bg-slate-50">
                      <h3 className="font-bold text-[#082652] mb-1">Execution & Handover</h3>
              ...
              {/* FAQs */}
              <div className="bg-white p-8 md:p-10 border border-border shadow-sm rounded-2xl">
                <h2 className="text-2xl font-extrabold text-[#082652] mb-6">Frequently Asked Questions</h2>
                <div className="space-y-4">
                  {faqs.map((faq, i) => (
                    <div key={i} className="border border-border rounded-xl overflow-hidden text-left bg-slate-50">
                      <button
                        onClick={() => setOpenFaq(openFaq === i ? null : i)}
                        className="w-full flex items-center justify-between p-5 text-left font-bold text-[#082652] hover:bg-zinc-100 transition-colors"
                      >
                        {faq.q}
            ...
            <div className="lg:col-span-5 relative w-full lg:sticky lg:top-8">
              <div className="border border-border/50 bg-white/95 backdrop-blur-sm p-8 md:p-10 rounded-3xl shadow-xl">
                <div className="mb-8 border-b border-border pb-6">
                  <h3 className="font-extrabold uppercase text-xl text-[#082652] mb-2">Request Proposal</h3>
                ...
                <form className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input id="name" placeholder="Enter your full name" className="h-14 border border-border focus:border-[#082652] rounded-xl font-medium bg-slate-50 px-4" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-xs uppercase font-bold tracking-widest text-zinc-500">Official Email</Label>
                    <Input id="email" type="email" placeholder="contact@company.com" className="h-14 border border-border focus:border-[#082652] rounded-xl font-medium bg-slate-50 px-4" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="interest" className="text-xs uppercase font-bold tracking-widest text-zinc-500">Service Required</Label>
                    <Select>
                      <SelectTrigger className="h-14 border border-border focus:border-[#082652] rounded-xl font-medium bg-slate-50 px-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" placeholder="Provide a brief overview of your infrastructure or compliance bottlenecks..." rows={4} className="resize-none border border-border focus:border-[#082652] rounded-xl font-medium p-4 bg-slate-50" />
                  </div>
                  ...
                  <div className="flex items-start space-x-3 pt-2">
                    ...
                    <Label htmlFor="terms" className="text-xs text-zinc-500 font-medium leading-relaxed">
                      I agree to the <Link href="/privacy-policy" className="text-[#082652] hover:underline">Privacy Policy</Link> and <Link href="/terms-of-service" className="text-[#082652] hover:underline">Terms of Service</Link>. I understand my data will be processed securely.
                    </Label>
                  </div>
              ...
              <div className="mt-8 flex flex-col md:flex-row gap-4 items-center justify-center">
                <div className="text-sm font-bold text-zinc-600">Email: <a href="mailto:contact@asarglobal.com" className="text-[#082652] hover:underline">contact@asarglobal.com</a></div>
                <div className="hidden md:block w-1.5 h-1.5 bg-border rounded-full"></div>
                <div className="text-sm font-bold text-zinc-600">HQ: <span className="text-[#082652]">ASAR Global Operations</span></div>
              </div>
            </div>
